...
class PartieTest {
  ...
  void devrait_faire_gagner_le_premier_joueur_a_3_manches() {
    ...
    joueurEquipeEsku.add(unJoueurFaisantChoix(new Mintza(), new Hordago(), new Mintza(), new Hordago(), new Mintza(), new Hordago(), new Mintza(), new Hordago(), new Mintza(), new Hordago()));
    var joueurEquipeZaku = new ArrayList<Joueur>();
    joueurEquipeZaku.add(unJoueurFaisantChoix(new Kanta(), new Mus(), new Paso(), new Kanta(), new Kanta(), new Mus(), new Paso(), new Kanta(), new Kanta()));
