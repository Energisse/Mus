...
public class MusEquipeTestPetit {
    ...
    @Test
    void joueur3et4_devrait_pas_jouer_apres_que_hordago_et_kanta_et_lequipe2_devrait_gagner2() {
        when(interfaceJoueur1.faireChoixParmi(anyList())).thenReturn(new Tira());
        when(interfaceJoueur2.faireChoixParmi(anyList())).thenReturn(new Hordago());
        when(interfaceJoueur3.faireChoixParmi(anyList())).thenReturn(new Kanta());
        when(interfaceJoueur4.faireChoixParmi(anyList())).thenReturn(new Paso());
