...
public class PetitEquipeTest {
    ...
    void setUp() {
        ...
        joueur1.donnerCartes(List.of(Carte.AS_BATON, Carte.SEPT_PIECE, Carte.SEPT_BATON, Carte.SIX_COUPE));
    ...
    void joueur3et4_devrait_pas_jouer_apres_que_hordago_et_kanta_et_lequipe2_devrait_gagner() {
        when(interfaceJoueur1.faireChoixParmi(anyList())).thenReturn(new Paso(),new Kanta());
        when(interfaceJoueur2.faireChoixParmi(anyList())).thenReturn(new Hordago());
    ...
    @Test
    void joueur4_devrait_pas_jouer_apres_hordago_et_2tira_et_lequipe2_devrait_gagner() {
    ...
    @Test
    void joueur4_devrait_pas_jouer_apres_hordago_et_kanta_et_lequipe2_devrait_gagner() {
        when(interfaceJoueur1.faireChoixParmi(anyList())).thenReturn(new Tira());
        when(interfaceJoueur2.faireChoixParmi(anyList())).thenReturn(new Paso(),new Kanta());
